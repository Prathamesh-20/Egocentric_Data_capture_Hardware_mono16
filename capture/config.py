...
# Between-segment FOV check (runs before every segment, including the first)
FOV_BETWEEN_SEGMENTS         = True
FOV_BETWEEN_SEGMENTS_SECS    = 4    # shorter than initial — just a re-verify
FOV_BETWEEN_MIN_DETECT_FRAMES= 6    # min frames with wrists detected to pass
FOV_MAX_CONSEC_FAILURES      = 3    # after this many fails in a row → abort session
FOV_RETRY_WAIT_SECS          = 2    # brief wait between retries (operator sees live feed)
